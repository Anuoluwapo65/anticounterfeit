      ...
      <div class="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
          ...
          <div class="sm:min-w-0 sm:flex-1">
            ...
            <p class="mt-2 text-base leading-7 text-gray-600">This is a universal solution as it can be used by anyone and from anywhere ✨</p>
          </div>
        </div>
        ...
        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
          ...
          <div class="sm:min-w-0 sm:flex-1">
            ...
            <p class="mt-2 text-base leading-7 text-gray-600">Unlike other services, this is free for and to all 😁.</p>
          </div>
        </div>
        ...
        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
          ...
          <div class="sm:min-w-0 sm:flex-1">
            ...
            <p class="mt-2 text-base leading-7 text-gray-600">Einstein probably made a significant mistake. We're the fastest beings alive ⚡</p>
          </div>
        </div>
        ...
        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
          ...
          <div class="sm:min-w-0 sm:flex-1">
            ...
            <p class="mt-2 text-base leading-7 text-gray-600">Even when you decide to use a pager, we're still gonna turn up 💪 </p>
          </div>
        </div>
      </div>
    </div>
